  ...
  useEffect(() => {
    ...
    fetchHomeRecoRows(pid)
      .then((data) => {
        ...
        const hasTrailer = (it) =>
          typeof it?.trailer_clip_url === "string" &&
          it.trailer_clip_url.trim().length > 0;
        ...
        // small delay makes UI feel nicer
        setTimeout(() => {
          if (!alive) return;
          setLoading(false);
        }, 150);
  ...
  return (
    <div className="homepage">
      ...
      <footer className="footer">
        <p>© 2026 Tauruss. All rights reserved.</p>
        ...
        <div className="modal-backdrop" onClick={closeMsg} role="presentation">
          ...
          >
            ...
            <p className="modal-text">
              ...
              at http://lcweb.loc.gov/copyright/), Tauruss will respond expeditiously
              to claims of copyright infringement that are reported to Tauruss’s
              designated copyright agent identified below. Please also note that
              under Section 512(f) any person who knowingly materially misrepresents
              that material or activity is infringing may be subject to liability.
              Tauruss reserves the right at its sole and entire discretion, to remove
              content and terminate the accounts of Tauruss users who infringe, or
              appear to infringe, the intellectual property or other rights of third
              parties.
              <br /><br />
              If you believe that your copywriten work has been copied in a way that
              constitutes copyright infringement, please provide Tauruss’s copyright
              ...
              by a single notification, a representative list of such works at the
              Website. Identification of the material that is claimed to be infringing
              ...
              to permit Tauruss to locate the material. Information reasonably sufficient
              to permit Tauruss to contact the complaining party, including a name, address,
              ...
              by the copyright owner, its agent or the law. A statement that the information
              in the notification is accurate and, under penalty of perjury, that the
              complaining party is authorized to act on behalf of an exclusive right that
              is allegedly infringed.
              <br /><br />
              All claims of copyright infringement on or regarding this Website should be
              delivered to Tauruss’s designated copyright agent at the following address:
              <br /><br />
              Copyright Contact Information:
              <br />
              Please contact us at taurusadmin@proton.me
              <br /><br />
              We apologize for any kind of misuse of our service and promise to do our best
              to find and terminate abusive files.
            </p>
          </div>
        </div>
      )}
